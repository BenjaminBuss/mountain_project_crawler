...
files = list(my_bucket.objects.filter(Prefix='forumCrawler/jsonData'))
...
my_bucket.upload_file('user_posts.csv', Key='forumCrawler/tidyied/user_posts.csv')
...
my_bucket.upload_file('user_urls.csv', Key='forumCrawler/tidyied/user_urls.csv')
